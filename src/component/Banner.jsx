      ...
      <div className=" mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center relative z-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <button className=" bg-[#9514FA] hover:bg-red-500 transition-all px-4 py-4 rounded-2xl font-semibold text-lg shadow-xl shadow-red-500/30 flex items-center gap-3 group text-white">
              Explore Products
            </button>
            <button className="bg-red-600 hover:bg-[#4F39F6] transition-all px-4 py-4 rounded-2xl font-semibold text-lg shadow-xl shadow-red-500/30 flex items-center gap-3 group text-white">
              Watch Demo
            </button>
          </div>
